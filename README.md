...
- [Развертывание на Ubuntu](docs/ubuntu-deployment.md) - Полная инструкция для чистого Ubuntu сервера
...
- [Инструкция для AI агента](docs/agents/AGENT_INTEGRATION_GUIDE.md) - Руководство для AI агента по подключению проектов
